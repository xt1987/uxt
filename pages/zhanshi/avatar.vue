<template>
    <uxt-layout :title="title">
        ...
        <uxt-title-bar
            ...
            title="深色头像"
        ></uxt-title-bar>
        <view class="padding grid col-5">
            <view class="padding-xs">
                <uxt-avatar>深</uxt-avatar>
            </view>
            <view
                :key="color"
                class="padding-xs"
            ...
            >
                <uxt-avatar :bg-color="color">深</uxt-avatar>
            </view>
            <view
                :key="color"
                class="padding-xs"
        ...
        <uxt-title-bar
            ...
            title="浅色头像"
        ></uxt-title-bar>
        <view class="bg-white padding grid col-5">
            <view
                :key="index"
                class="padding-xs"
        ...
        <uxt-title-bar
            classes="margin-top-sm solid-bottom"
            subTitle="uxt-avatar-group"
            title="头像组"
        ></uxt-title-bar>
        <view class="bg-white padding">
            <uxt-avatar-group size="sm">
                <uxt-avatar
                    :key="i"
                    avatar="https://ossweb-img.qq.com/images/lol/web201310/skin/big10001.jpg"
                    round
