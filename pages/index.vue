<template>
    ...
    >
        <uxt-title-bar
            bg-color=" "
            classes="margin-bottom solid-bottom"
            title="内置样式"
        ></uxt-title-bar>
        <view class="nav-list">
            <navigator
        ...
        <view class="nav-list">
            <navigator
                :class="[`bg-${item.color}`]"
                :key="index"
                :url="`/pages/jichu/${item.name}`"
                class="nav-li"
                hover-class="none"
                v-for="(item, index) in jichu"
            >
                <view class="nav-title">{{ item.title }}</view>
                <view class="nav-name">{{ item.name }}</view>
                <view class="nav-icon">
        ...
        <view class="nav-list">
            <navigator
                :class="[`bg-${item.color}`]"
                :key="index"
                :url="`/pages/biaodan/${item.name}`"
                class="nav-li"
                hover-class="none"
                v-for="(item, index) in biaodan"
            >
                <view class="nav-title">{{ item.title }}</view>
                <view class="nav-name">{{ item.name }}</view>
                <view class="nav-icon">
